...
const characters = {
  ...
  /* PASOS:
  1. Recuperar el contenedor de HTML (NODO)
  2. Mapear a los personajes para quedarnos con la info que nos solicita
  2.1 Declarar la función que, recorriendo una lista, nos pinte templates de html en el documento
  2.2 Iterar en la lista y por cada uno de los item
  
  */
  
//1. Recuperar (NODO = enlace con una etiqueta de html)
const container = document.querySelector("#container");
console.log(container);

//2.1 Declarar función
const tempInDocument = (result) => {
